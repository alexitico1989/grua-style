...
🔗 [Ver en Admin]({settings.BASE_HOST}/admin/grua_app/solicitudservicio/{solicitud.id}/change/)
...
Ver detalles: {settings.BASE_HOST}/admin/grua_app/solicitudservicio/{solicitud.id}/change/
"""
